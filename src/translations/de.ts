export const de = {
  ...
  helpDialog: {
    ...
    gotIt: 'Verstanden!',
    rulesItems: [
      'Das Spiel wird auf einem 9×9-Raster gespielt, auf dem farbige Kugeln erscheinen.',
      'Pro Zug werden 3 neue Kugeln mit zufälligen Farben zum Spielfeld hinzugefügt.',
      'Wähle eine Kugel aus und klicke auf ein leeres Feld, um sie zu bewegen.',
